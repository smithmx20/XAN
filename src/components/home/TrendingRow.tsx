...
// components/home/TrendingRow.tsx
// ✅ Horizontal scroller showing the hottest anime right now.
// ✅ Matches the visual style of xancld.xyz's "Trending Now" section:
//    trend icon, "Trending Now" heading, "The hottest anime right now."
//    subtitle, portrait cards with score badge and title.
// ✅ Distinct from TopTenRow (which is XAN's ranked "Top 10 Today" feature):
//    this row shows up to 15 items, no rank framing, no "Ranked" badge.
...
/**
 * Trending Now — horizontal scroller of currently trending anime.
 * Shows up to 15 items, no rank framing.
 */
export function TrendingRow({ anime }: TrendingRowProps) {
